...
Scenario Outline: Sign messages
	...
	| Este es un pequeño mensaje en Español, ¿Qué?   |
...
Scenario Outline: Verify signatures
	...
	| Este es un pequeño mensaje en Español, ¿Qué? | 2ljmQEoYDn/UWHEB4WBvppWa4N5wxt1l4+YgCy+Suuf57KBSirFmkdRm2l+Vs+6azonIM2y1cmpGMUFbvXq9AA== | MCowBQYDK2VwAyEAGWAlFKYSMLbMq6kdGMKftdy9Kg98YZbCcu2g7TTGvNw= |